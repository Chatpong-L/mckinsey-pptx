...
NOTES = {
    ...
    15: "Founding story, 45 seconds max. Read the quote, add one personal line, move on. [T+0:19]",
    ...
    42: "THE ask. Type 1 (buy) / 2 (sell) / 3 (refer), scan QR, or add LINE. Say it twice. QR stays up through Q&A. [T+1:08]",
