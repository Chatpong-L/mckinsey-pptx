...
NOTES = {
    ...
    4: "30 seconds each. Max: keep the founder story to ONE line here, the full beat comes at slide 17. [T+0:06]",
    5: "Section 1 · WHY NOW. Budget 14 minutes. [T+0:07]",
    6: "Big line: 'COVID knocked four trillion baht off the market. The recovery ran at nine percent a year.'",
    ...
    9: "This room's four sectors. Logistics people: 9,399 mid-market targets is YOUR number. Move briskly, the drill-down is next.",
    10: "The nuance slide: growth and profit are different places in logistics. 3PL is the clean story; couriers grew broke. 90 seconds.",
    11: "One hero, three runners. Pet food is the 'growth AND margin' proof. Mention the artifact-stripping line: that's analyst rigor.",
    12: "90 seconds max. The room knows this distinction, it's a bridge slide.",
    13: "Key claim: SME deals pay back in 3-8 years vs 10+ for mega-deals. Japan's 16x growth is the evidence the wave is real.",
    14: "Credibility beat: this is KPMG data published last month. Note: headlines are big-cap, our layer is the SME market below them.",
    15: "SLOW DOWN. This is the screenshot slide. Read the stat twice. 'No one else in Thailand can compute this number.'",
    16: "Public-record confirmation of our registry finding. The Japan tile is the preview of Thailand's next decade.",
    17: "Founding story, 45 seconds max. Read the quote, add one personal line, move on. [T+0:21]",
    18: "Section 2 · WHAT GOOD LOOKS LIKE. Budget 14 minutes. [T+0:21]",
    ...
    26: "Two minutes max, this is setup for the ladder.",
    27: "Our ecosystem. Not a pitch: the first two doors are free to open tonight.",
    28: "Screenshot shown is an illustrative preview; show the real Facebook group live if the connection allows.",
    29: "This is the REAL dealflowmarket.com, captured this week. Pick one listing that matches the poll-1 mix, talk 30 seconds.",
    30: "Position Max Data as the research layer under every stage, not another listing site.",
    31: "DEMO MOMENT. Recorded fallback ready. Filter: Logistics, ฿10M-1B revenue → 9,399 companies on screen. [T+0:45]",
    32: "Section 4 · HOW A DEAL RUNS. Budget 8 minutes. [T+0:47]",
    33: "Walk the six steps in about 4 minutes. Add the LOI + deposit nuance from real deals.",
    34: "Sellers: 60 seconds. Full sell-side detail is in the appendix and on the website.",
    35: "Section 5 · PROOF. Budget 13 minutes. [T+0:55]",
    36: "Launch poll 3. Use the result to decide which case to emphasize.",
    37: "The pipeline slide. Read one profile aloud slowly. 'Fourteen thousand of these.' Then: 'so who's buying them?'",
    38: "Let 35.1% breathe. Then: 'this playbook is arriving in Thailand.'",
    39: "Tell it as a story: the couple, no successor, the sharp buyer, the New Year visit where everyone was happy.",
    40: "Contrast case: foreign buyer, end-to-end process, now doubling turnover.",
    41: "Generalize the pattern: succession + inefficiency + capable buyer.",
    42: "Callback to the demo: 'your edge is seeing what others cannot.' [T+1:06]",
